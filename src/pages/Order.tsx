              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    />
                    {errors.name && (
                      <p data-testid="error-name" className="text-sm text-destructive">
                        {errors.name}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.cpf && (
                      <p data-testid="error-document" className="text-sm text-destructive">
                        {errors.cpf}
                      </p>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    {errors.store && (
                      <p data-testid="error-store" className="text-sm text-destructive">
                        {errors.store}
                      </p>
                    )}
                  </div>
              ...
              <section className="bg-card rounded-lg p-6 shadow-elegant">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    {errors.terms && (
                      <p data-testid="error-terms" className="text-sm text-destructive mt-1">
                        {errors.terms}
                      </p>
                    )}
                  </div>
